  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <main className="max-w-md mx-auto px-4 py-10">
        ...
        <p className="text-sm text-gray-600 mt-4">New to TrialCliniq? <Link to="/sites/create-account" className="text-blue-600 hover:underline">Create an account</Link></p>
      </main>
    </div>
  );
}
