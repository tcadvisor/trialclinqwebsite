  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        <h1 className="text-3xl font-semibold mb-4">TrialCliniq Support Center</h1>
        <p className="text-gray-700">Contact support or access onboarding guides for investigators.</p>
      </main>
    </div>
  );
}
