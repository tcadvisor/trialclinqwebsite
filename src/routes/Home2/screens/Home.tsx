...
import { Search, CheckCircle2, Shield, UserRound, ArrowRight, HelpCircle, UserPlus, LogIn, Newspaper, Megaphone, Building2, Headset } from "lucide-react";
      ...
      <header className="sticky top-0 z-30 bg-white/80 backdrop-blur border-b">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
                    ...
                    <ul className="divide-y">
                      <li>
                        <Link to="/sites/blog" onClick={() => setSitesOpen(false)} className="flex gap-4 p-4 rounded-xl hover:bg-gray-50">
                          <div className="shrink-0 rounded-lg bg-blue-50 p-2"><Newspaper className="h-5 w-5 text-blue-700" /></div>
                          <div>
                      ...
                      <li>
                        <Link to="/sites/multicenter" onClick={() => setSitesOpen(false)} className="flex gap-4 p-4 rounded-xl hover:bg-gray-50">
                          <div className="shrink-0 rounded-lg bg-blue-50 p-2"><Building2 className="h-5 w-5 text-blue-700" /></div>
                          <div>
                      ...
                      <li>
                        <Link to="/sites/support" onClick={() => setSitesOpen(false)} className="flex gap-4 p-4 rounded-xl hover:bg-gray-50">
                          <div className="shrink-0 rounded-lg bg-blue-50 p-2"><Headset className="h-5 w-5 text-blue-700" /></div>
                          <div>
                      ...
                      <li>
                        <Link to="/sites/create-account" onClick={() => setSitesOpen(false)} className="flex gap-4 p-4 rounded-xl hover:bg-gray-50">
                          <div className="shrink-0 rounded-lg bg-blue-50 p-2"><UserPlus className="h-5 w-5 text-blue-700" /></div>
                          <div>
                      ...
                      <li>
                        <Link to="/sites/login" onClick={() => setSitesOpen(false)} className="flex gap-4 p-4 rounded-xl hover:bg-gray-50">
                          <div className="shrink-0 rounded-lg bg-blue-50 p-2"><LogIn className="h-5 w-5 text-blue-700" /></div>
                          <div>
          ...
          <div className="flex items-center gap-3">
            <Link to="/signin" className="px-4 py-2 text-sm rounded-full border border-blue-600 text-blue-700 hover:bg-blue-50">Sign in</Link>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 pt-14 pb-16 text-center">
          ...
          <form
            ...
            className="mt-10 bg-white/80 backdrop-blur rounded-2xl shadow-xl ring-1 ring-black/5 p-5 sm:p-7 max-w-4xl mx-auto"
          >
            <div className="grid sm:grid-cols-3 gap-3 sm:gap-4 items-end">
              ...
              <button
                type="submit"
                className="sm:col-span-1 inline-flex items-center justify-center gap-2 rounded-full bg-blue-600 text-white px-4 py-2.5 font-medium hover:bg-blue-700"
              >
