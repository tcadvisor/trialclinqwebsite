    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 pt-20 pb-24 text-center">
          ...
          >
            <div className="grid sm:grid-cols-2 gap-3 sm:gap-4 items-end">
              <SearchAutocomplete
                value={query}
                onChange={setQuery}
              ...
              <label className="text-left text-xs text-gray-600">
                ...
                <input
                  ...
                  className="w-full border border-gray-300 px-4 py-3 placeholder:text-gray-400/80 focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div className="mt-4">
              <button
                type="submit"
                className="w-full inline-flex items-center justify-center gap-2 rounded-full bg-blue-600 text-white px-6 py-3 text-sm font-medium hover:bg-blue-700"
              >
