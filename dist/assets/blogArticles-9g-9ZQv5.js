const e=[{id:"accelerate-recruitment",title:"7 tactics to accelerate site recruitment",excerpt:"Practical steps sites are using to cut screening times and improve referral quality.",author:"Sarah Mitchell",publishedDate:"2025-01-15",readTime:8,category:"Recruitment",content:`
...
The key to acceleration isn't just speed—it's creating a process that's efficient, patient-friendly, and maintains the quality and integrity of your trial.
    `},{id:"digital-recruitment-budget",title:"Budgeting digital recruitment for 2025",excerpt:"How to forecast paid, owned, and partner channels for enrollment milestones.",author:"James Chen",publishedDate:"2025-01-12",readTime:10,category:"Budget & Strategy",content:`
...
Your budget should flex and flow with real performance data. The sites that succeed are those that monitor metrics weekly and adjust monthly.
    `},{id:"coordinators-toolkit",title:"Coordinators' toolkit: from prescreen to consent",excerpt:"Templates and checklists for consistent patient communications and privacy compliance.",author:"Jennifer Rodriguez",publishedDate:"2025-01-08",readTime:12,category:"Best Practices",content:`
...
The patient coordinators who excel do so because they treat every patient interaction as if that patient's experience matters—because it does. This toolkit helps you do that consistently and with confidence.
    `}];function i(t){return e.find(n=>n.id===t)}function a(){return e}export{i as a,a as g};
