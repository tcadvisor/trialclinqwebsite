...
exports.createCorsHandler = createCorsHandler;
 ...
 */
function getCorsHeaders(origin, methods = "GET,POST,PUT,DELETE,OPTIONS", headers = "content-type,authorization,x-csrf-token,x-user-id,x-patient-id", credentials = false) {
 ...
 */
function corsResponse(statusCode, body, origin, methods = "GET,POST,PUT,DELETE,OPTIONS", headers = "content-type,authorization,x-csrf-token,x-user-id,x-patient-id", additionalHeaders = {}) {
 ...
 */
function handleOptions(origin, methods = "GET,POST,PUT,DELETE,OPTIONS", headers = "content-type,authorization,x-csrf-token,x-user-id,x-patient-id") {
 ...
 * ```
 */
function createCorsHandler(event) {
    const origin = event.headers?.origin || event.headers?.Origin;
    return {
        /**
         * Create a CORS response
         */
        response: (statusCode, body, methods, additionalHeaders) => {
            return corsResponse(statusCode, body, origin, methods, undefined, additionalHeaders);
        },
        /**
 ...
 */
function response(statusCode, body, origin, methods, headers, additionalHeaders) {
