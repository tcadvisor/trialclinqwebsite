const handler = require('../netlify/functions/provider-write.js');
...
function buildNetlifyEvent(context, req) {
  ...
  return { httpMethod: method, headers, queryStringParameters, body, isBase64Encoded: false, path: '/api/provider-write' };
}
...
module.exports = async function (context, req) {
  try {
    ...
    console.error('[provider-write-handler] Error:', error.message);
