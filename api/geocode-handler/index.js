const handler = require('../netlify/functions/geocode.js');
...
function buildNetlifyEvent(context, req) {
  ...
  return { httpMethod: method, headers, queryStringParameters, body, isBase64Encoded: false, path: '/api/geocode' };
}
...
module.exports = async function (context, req) {
  try {
    ...
    console.error('[geocode-handler] Error:', error.message);
