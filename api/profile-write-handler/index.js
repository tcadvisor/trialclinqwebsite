const handler = require('../netlify/functions/profile-write.js');
...
function buildNetlifyEvent(context, req) {
  ...
  return { httpMethod: method, headers, queryStringParameters, body, isBase64Encoded: false, path: '/api/profile-write' };
}
...
module.exports = async function (context, req) {
  try {
    ...
    console.error('[profile-write-handler] Error:', error.message);
