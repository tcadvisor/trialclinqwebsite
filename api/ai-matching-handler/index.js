const handler = require('../netlify/functions/ai-matching.js');
...
function buildNetlifyEvent(context, req) {
  ...
  return { httpMethod: method, headers, queryStringParameters, body, isBase64Encoded: false, path: '/api/ai-matching' };
}
...
module.exports = async function (context, req) {
  try {
    ...
    console.error('[ai-matching-handler] Error:', error.message);
