const handler = require('../netlify/functions/ctgov.js');
...
function buildNetlifyEvent(context, req) {
  ...
  return { httpMethod: method, headers, queryStringParameters, body, isBase64Encoded: false, path: '/api/ctgov' };
}
...
module.exports = async function (context, req) {
  try {
    ...
    console.error('[ctgov-handler] Error:', error.message);
