const handler = require('../netlify/functions/provider-matches.js');
...
function buildNetlifyEvent(context, req) {
  ...
  return { httpMethod: method, headers, queryStringParameters, body, isBase64Encoded: false, path: '/api/provider-matches' };
}
...
module.exports = async function (context, req) {
  try {
    ...
    console.error('[provider-matches-handler] Error:', error.message);
