const handler = require('../netlify/functions/get-trial-interests.js');
...
function buildNetlifyEvent(context, req) {
  ...
  return { httpMethod: method, headers, queryStringParameters, body, isBase64Encoded: false, path: '/api/get-trial-interests' };
}
...
module.exports = async function (context, req) {
  try {
    ...
    console.error('[get-trial-interests-handler] Error:', error.message);
