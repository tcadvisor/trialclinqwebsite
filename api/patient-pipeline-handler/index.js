const handler = require('../netlify/functions/patient-pipeline.js');
...
function buildNetlifyEvent(context, req) {
  ...
  return { httpMethod: method, headers, queryStringParameters, body, isBase64Encoded: false, path: '/api/patient-pipeline' };
}
...
module.exports = async function (context, req) {
  try {
    ...
    console.error('[patient-pipeline-handler] Error:', error.message);
