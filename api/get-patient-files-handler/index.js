const handler = require('../netlify/functions/get-patient-files.js');
...
function buildNetlifyEvent(context, req) {
  ...
  return { httpMethod: method, headers, queryStringParameters, body, isBase64Encoded: false, path: '/api/get-patient-files' };
}
...
module.exports = async function (context, req) {
  try {
    ...
    console.error('[get-patient-files-handler] Error:', error.message);
