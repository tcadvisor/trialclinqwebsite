const handler = require('../netlify/functions/book-demo.js');
...
function buildNetlifyEvent(context, req) {
  ...
  return { httpMethod: method, headers, queryStringParameters, body, isBase64Encoded: false, path: '/api/book-demo' };
}
...
module.exports = async function (context, req) {
  try {
    ...
    console.error('[book-demo-handler] Error:', error.message);
