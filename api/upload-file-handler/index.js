const handler = require('../netlify/functions/upload-file.js');
...
function buildNetlifyEvent(context, req) {
  ...
  return { httpMethod: method, headers, queryStringParameters, body, isBase64Encoded: false, path: '/api/upload-file' };
}
...
module.exports = async function (context, req) {
  try {
    ...
    console.error('[upload-file-handler] Error:', error.message);
