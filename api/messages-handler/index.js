const handler = require('../netlify/functions/messages.js');
...
function buildNetlifyEvent(context, req) {
  ...
  return { httpMethod: method, headers, queryStringParameters, body, isBase64Encoded: false, path: '/api/messages' };
}
...
module.exports = async function (context, req) {
  try {
    ...
    console.error('[messages-handler] Error:', error.message);
