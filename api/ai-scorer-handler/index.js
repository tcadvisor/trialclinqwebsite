const handler = require('../netlify/functions/ai-scorer.js');
...
function buildNetlifyEvent(context, req) {
  ...
  return { httpMethod: method, headers, queryStringParameters, body, isBase64Encoded: false, path: '/api/ai-scorer' };
}
...
module.exports = async function (context, req) {
  try {
    ...
    console.error('[ai-scorer-handler] Error:', error.message);
