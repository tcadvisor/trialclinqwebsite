const handler = require('../netlify/functions/whoami.js');
...
function buildNetlifyEvent(context, req) {
  ...
  return { httpMethod: method, headers, queryStringParameters, body, isBase64Encoded: false, path: '/api/whoami' };
}
...
module.exports = async function (context, req) {
  try {
    ...
    console.error('[whoami-handler] Error:', error.message);
