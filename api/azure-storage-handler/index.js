const handler = require('../netlify/functions/azure-storage.js');
...
function buildNetlifyEvent(context, req) {
  ...
  return { httpMethod: method, headers, queryStringParameters, body, isBase64Encoded: false, path: '/api/azure-storage' };
}
...
module.exports = async function (context, req) {
  try {
    ...
    console.error('[azure-storage-handler] Error:', error.message);
