const handler = require('../netlify/functions/custom-trials.js');
...
function buildNetlifyEvent(context, req) {
  ...
  return { httpMethod: method, headers, queryStringParameters, body, isBase64Encoded: false, path: '/api/custom-trials' };
}
...
module.exports = async function (context, req) {
  try {
    ...
    console.error('[custom-trials-handler] Error:', error.message);
