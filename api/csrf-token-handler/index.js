const handler = require('../netlify/functions/csrf-token.js');
...
function buildNetlifyEvent(context, req) {
  ...
  return { httpMethod: method, headers, queryStringParameters, body, isBase64Encoded: false, path: '/api/csrf-token' };
}
...
module.exports = async function (context, req) {
  try {
    ...
    console.error('[csrf-token-handler] Error:', error.message);
