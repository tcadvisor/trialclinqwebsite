const handler = require('../netlify/functions/provider-trials.js');
...
function buildNetlifyEvent(context, req) {
  ...
  return { httpMethod: method, headers, queryStringParameters, body, isBase64Encoded: false, path: '/api/provider-trials' };
}
...
module.exports = async function (context, req) {
  try {
    ...
    console.error('[provider-trials-handler] Error:', error.message);
